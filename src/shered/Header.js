                        ...
                        <div className="row ">
                            ...
                            <div className="col-lg-6 col-md-6">
                                <form className="header-search-box header-search-box-two ms-3">
                                    <input className="form-control" type="text" id="search" placeholder="Search Products" />
                            ...
                            <div className="col-lg-3 col-md-2 login_shop">
                                <Link href="login-register.html" className="header-action-account">Login</Link >
                                <Link className="header-action-wishlist" href="shop-wishlist.html">
                    ...
                    <div className="container-fluid">
                        ...
                        <div className="phone-item-action phone-item-action--two">
                            ...
                            <div className="phone-item-content">
                                <span>Call Us 24/7</span> <Link href="tel:+00123456789">+00 123 456 789</Link >
                            </div>
                        </div>
                    </div>
